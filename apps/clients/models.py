...
#     )
#     national_id = models.CharField(_('National ID'), max_length=255, blank=True, null=True, unique=True)
#     nationality = models.CharField(_('Nationality'), max_length=255)
#     passport_number = models.CharField(_('Passport Number'), max_length=255, blank=True, null=True, unique=True,)
#     passport_country = CountryField(
#         verbose_name=_("Passport Country"), blank=False, null=False
#     )
#     photo = models.CharField(_('Photo'), max_length=255, blank=True, null=True)
#     date_of_birth = models.DateField(_('Date of Birth'), blank=True, null=True)
#     title = models.CharField(_('Title'), max_length=10, choices=[('Dr', 'Dr'), ('Miss', 'Miss'), ('Mr', 'Mr'), ('Mrs', 'Mrs'), ('Ms', 'Ms'), ('Prof', 'Prof')])
...
#     type = models.CharField(_('Contact Type'), max_length=20, choices=[('Cellphone', 'Cellphone'), ('Home', 'Home'), ('Work', 'Work'), ('Other', 'Other')])
