...
class Client(TimeStampedModel):
    ...
    national_id = models.CharField(_('National ID'), max_length=255, blank=True, null=True)
    nationality = models.CharField(_('Nationality'), max_length=255)
    passport_number = models.CharField(_('Passport Number'), max_length=255, blank=True, null=True)
    passport_country = CountryField(
        verbose_name=_("Passport Country"), default="ZW", blank=False, null=False
    )
